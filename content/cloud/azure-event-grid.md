...
An Event is the actual message that something happened.
...
This is the end point where the events are sent/ published.
...
# 3.Event Subsciption  
This is not your typical Azure subscription.
